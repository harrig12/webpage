...
description: <a href="cv.html" class="cv_button" onClick="window.print()">Print this CV</a>
output:
...
BibOptions(bib.style = "embedURL", match.author = "exact", 
                   ...
                   style = "text", no.print.fields = c("doi","urldate", "issn"))
```
...
cait.harrigan<i class="fas fa-at" style="font-size: 5pt"></i>mail.utoronto.ca  \|  View this CV online at [caitharrigan.ca/cv](caitharrigan.ca/cv.html)
</p>
...
```{r volunteering}
cv_entries %>%
  filter(type == 'volunteering' | type == 'event_org') %>%
  #shortEntry()
  longEntry(showDesc = T)
```
